...
@Component({
  selector: 'app-fourth-stage',
  templateUrl: './fourth-stage.component.html',
  styleUrls: ['./fourth-stage.component.css']
})
export class FourthStageComponent implements OnInit {
